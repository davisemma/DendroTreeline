...
all.site
#ggsave(plot=all.site, "~/Desktop/AllSiteEstJCO_2020.pdf", device = "pdf", width = 3.75, height = 3.25, units = c("in"), dpi= 600)

#Building linear models
modWIL<-lm(Elev ~ Perc, SiteID=='WIL', data=quantiles)
summary(modWIL)

stargazer(modWIL, type = "text",
          digits = 3,
...
#Movement rates from slop of regression line
...
#ggsave(plot=est.yrs, "EstYrs.pdf", device = "pdf", width = 5, height = 4.5, units = c("in"), dpi= 600)
